...
parser.add_argument('--start-freq', default=1, type=int, metavar='N',
                    help='start point')
parser.add_argument('--loss', default='trades_w', type=str, 
                    choices=['pgd', 'pgd_he', 'alp', 'alp_he', 'trades', 'trades_he', 'pgd_he2', 'pgd_he_lkh', 'pgd_he_lkh_margin', 'pgd_he2_lkh', 'pgd_he3', 'pgd_he3_lkh', 'trades_ce', 'trades_w', 'Curricular', 'adaloss', 'ang'])
...
parser.add_argument('--r', default=0.01, type=float, help='r value')
...
LOSS= {
        ...
        'pgd_he2':pgd_loss,
        'pgd_he_lkh':pgd_loss,
        'pgd_he_lkh_margin':pgd_loss,
        'pgd_he2_lkh':pgd_loss,
        'pgd_he3':pgd_loss,
        'pgd_he3_lkh':pgd_loss,
        'trades_ce': trades_loss,
        'trades_w': trades_loss,
        'Curricular':pgd_loss,
        'adaloss':pgd_loss,
        'ang':pgd_loss,
}
...
def main():
    ...
    if args.loss == 'alp' or args.loss == 'trades' or args.loss == 'pgd' or args.loss == 'trades_w':
