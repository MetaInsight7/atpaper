...
parser.add_argument('--model-path', type=str, default='./checkpoint/trades_w/wideres-epoch38.pt')
parser.add_argument('--use_FNandWN', action='store_false')
parser.add_argument('--batch-size', type=int, default=100)
parser.add_argument('--n-ex', type=int, default=10000)
parser.add_argument('--widen_factor', type=int, default=10, choices=[10, 20])
parser.add_argument('--logfile', default='./checkpoint/adaloss/result.log', type=str, help='save log')                  
...
if args.model == 'WideResNet':
    if args.use_FNandWN:
        model = WideResNet(34, num_classes=10, widen_factor=args.widen_factor, dropRate=0.0, use_FNandWN=True, i_normalize=True)
    else:
